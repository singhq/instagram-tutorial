...
if(isset($_POST['action'])){
  ...
  GROUP BY user_post.post_id ORDER BY post_id DESC";
   ...
   while($row =mysqli_fetch_assoc($result)){
    ...
    echo "<div class='manu-main-container'>
            ...
            <li class='manu-name-icon-icon'><a href='profile_user.php' class='user_button' data-post_id='$postid'>$username</a></li>
       ...
       <div class='manu-post-container'>
        ...
        <img src='".$posturl."' height='50' width='50'/>
           ...
           <div class='main-post-icon-container'>
            ...
            <li class='comment-manu-icon'><a href='#comment' class='comment_button' data-user_image='$user_image' data-user_id='.$userid.' data-post_id='.$postid'><i class='far fa-comment'></i></a></li>
 ...
 if($_POST['action_like']=='like'){
  ...
  // $postlike =$_POST['post_like'];
    
 
  $sql = "INSERT INTO `post_like`( `user_id`, `post_id`) VALUES ('$userid' ,'$postid')";
 ...
 //$follow = $_POST['action_follow'];
  ...
  $sql = "DELETE FROM `post_like` WHERE `user_id` ='$userid' AND `post_id` ='$postid'";
   $sql_result = mysqli_query($conn , $sql);
 if($sql_result){
 echo "success";
...
<div id="user-profile" class="user-profile-home-container">
<?php
include 'user_profile-new.php';
...
?>
 ...
 <script src="jquery-3.5.1.min.js"></script>
  ...
  $("#heart").click(function(){  
   ...
   // problme to data insert karne me hai jquery            
       ...
       $(document).on('click','.like_button', function(){   
          ...
          var post_like  =$(this).data('action');
       ...
       // else if($clicked.hasClass()){
        ...
        // data:{action_follow:follow, user_id:userid,follow_id:followid},
         ...
         $.post("instagram.php",{action_like:post_like, user_id:userid,post_id:postid }
